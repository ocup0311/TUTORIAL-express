...
exports.author_create_post = [
  ...
  validator.sanitizeBody('date_of_birth').trim().toDate(),
  validator.sanitizeBody('date_of_death').trim().toDate(),
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      res.render('author_form', { title: '新增作者', author: author, errors: errors.array() })
    } else {
